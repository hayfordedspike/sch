  ...
  <div class="visit-management">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
      <div>
        ...
        <p class="text-gray-600 mt-1">Manage client visits and schedules</p>
      </div>
    ...
    <div v-if="loading && visits.length === 0" class="text-center py-8">
      ...
      <p class="text-gray-500 mt-2">Loading visits...</p>
    </div>
    ...
    <div v-else-if="visits.length === 0" class="text-center py-8">
      ...
      <p class="text-gray-500">Get started by adding your first visit.</p>
    </div>
